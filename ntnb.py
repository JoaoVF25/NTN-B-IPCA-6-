...
# Adicionar a coluna 'codigo' com o valor 'NTN-B 35'
...
# Remover as colunas existentes no DataFrame
df_dados = df_dados.drop(colunas_existentes, axis=1)

# Filtrar o DataFrame para manter apenas as linhas onde 'taxaJurosCompra' é maior que 0.02
...
# Supondo que 'df_dados' seja o DataFrame com as taxas de juros de compra filtradas
...
# Calcular a porcentagem de dias úteis com taxas de juros de compra acima de 7.5%
...
# Calcular a porcentagem de dias úteis com taxas de juros de compra acima de 7.0%
porcentagem_taxas_acima_de_70 = (total_registros_acumulado2 / dias_uteis) * 100

# Repetir o processo para as demais faixas de taxas de juros
# Para 6.5%
